...
public class Loadfile {
	...
	public static void getdata()
	{
		...
		try
		{
			...
			//*****新增data物件*****//
			ACO.pointdata = new data[Integer.parseInt(tmparray[0])];
			...
			{
				tmparray = tmp.split(" ");
				ACO.pointdata[i] = new data();
				ACO.pointdata[i].x = Double.valueOf(tmparray[0]);
				ACO.pointdata[i].y = Double.valueOf(tmparray[1]);
